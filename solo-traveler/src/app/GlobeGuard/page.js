      ...
      <div className="flex justify-center items-center flex-col">
        ...
        <div className="flex flex-col items-center mt-20">
          ...
          <p className="text-lg mb-5">
            Stay informed about the latest travel advisories and safety tips for
            your next adventure.
          </p>
        </div>
          ...
          <form action="/search" className="max-w-[480px] w-full px-4">
            <div className="relative">
              <input
                type="text"
                name="q"
                className="w-full border h-12 shadow p-4 rounded-full dark:text-gray-800 dark:border-gray-700 dark:bg-gray-100"
                placeholder="search"
              ></input>
              <button type="submit">
                <svg
